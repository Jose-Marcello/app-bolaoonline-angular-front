...
import { UpdatePerfilRequestDto } from '../../features/apostador/models/update-perfil-request.model'; // Importação do novo DTO
...
export class ApostadorService {
  ...
  // No arquivo apostador.service.ts
uploadFoto(formData: FormData): Observable<any> {
  // Verifique se o endereço da sua API está correto aqui  
