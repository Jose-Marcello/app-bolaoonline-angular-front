...
import { RodadaDto } from "../../rodada/model/rodada-dto.model"; // Importa RodadaDto
import { ApostasAvulsasTotaisDto } from '../../aposta-rodada/models/apostas-avulsas-totais-dto.model'; // Adicione este import
