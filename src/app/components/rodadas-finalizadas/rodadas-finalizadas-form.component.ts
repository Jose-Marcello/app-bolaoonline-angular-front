...
@Component({
  selector: 'app-rodadas-finalizadas-form',
  standalone: true,
  imports: [
    CommonModule,
    MatCardModule,
...
    CurrencyPipe
  ],
  templateUrl: './rodadas-finalizadas-form.component.html',
  styleUrls: ['./rodadas-finalizadas-form.component.scss']
})
export class RodadasFinalizadasFormComponent implements OnInit, OnDestroy {
...
    const rodadas$ = this.rodadaService.getRodadasFinalizadas(this.campeonatoId!).pipe(
      map(response => {
...
            this.rodadasFinalizadas = rodadas;
            this.rodadaSelecionada = this.rodadasFinalizadas.find(r => r.id === this.rodadaId!) || null;
...
      return;
    }
    this.rodadaSelecionada = this.rodadasFinalizadas.find(r => r.id === rodadaId) || null;
    if (this.rodadaSelecionada) {
