    ...
    import { NotificationDto } from '../models/notification.model'; // Importa NotificationDto
    ...
    export interface ApiResponse<T> {
      ...
      errorCode?: string; // Propriedade para códigos de erro específicos da aplicação
